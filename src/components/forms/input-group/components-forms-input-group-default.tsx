    ...
    >
      <div className='mb-5'>
        <form>
          ...
          <div>
            <div className='flex'>
              <div className='border-white-light flex items-center justify-center whitespace-nowrap border bg-[#eee] px-3 font-semibold ltr:rounded-l-md ltr:border-r-0 rtl:rounded-r-md rtl:border-l-0 dark:border-[#17263c] dark:bg-[#1b2e4b]'>
                With textarea
              </div>
              <textarea
                rows={4}
