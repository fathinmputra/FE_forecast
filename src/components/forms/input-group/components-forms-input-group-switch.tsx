      ...
      <div className='mb-5'>
          ...
          <div className='flex'>
            <div className='border-white-light flex items-center justify-center border bg-[#eee] px-3 font-semibold ltr:rounded-l-md ltr:border-r-0 rtl:rounded-r-md rtl:border-l-0 dark:border-[#17263c] dark:bg-[#1b2e4b]'>
              <label className='relative mb-0 h-4 w-7 cursor-pointer'>
                ...
                />
                <span className='peer-checked:border-primary peer-checked:bg-primary dark:bg-dark dark:before:bg-white-dark block h-full rounded-full border border-[#adb5bd] bg-white before:absolute before:bottom-[2px] before:h-3 before:w-3 before:rounded-full before:bg-[#adb5bd] before:transition-all before:duration-300 peer-checked:before:bg-white ltr:before:left-0.5 ltr:peer-checked:before:left-3.5 rtl:before:right-0.5 rtl:peer-checked:before:right-3.5'></span>
              </label>
            </div>
            <input
              id='switchLeft'
        ...
        <div>
          ...
          <div className='flex'>
            ...
            />
            <div className='border-white-light flex items-center justify-center border bg-[#eee] px-3 font-semibold ltr:rounded-r-md ltr:border-l-0 rtl:rounded-l-md rtl:border-r-0 dark:border-[#17263c] dark:bg-[#1b2e4b]'>
              <label className='relative mb-0 h-4 w-7 cursor-pointer'>
                <input
                  type='checkbox'
                  className='peer absolute z-10 h-full w-full cursor-pointer opacity-0 focus:outline-none focus:ring-0'
