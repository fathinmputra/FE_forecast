        ...
        <form>
          <div className='mb-5'>
            <div className='flex'>
              ...
              <div className='border-white-light flex items-center justify-center rounded-none border bg-[#eee] px-3 font-semibold ltr:border-r-0 rtl:border-l-0 dark:border-[#17263c] dark:bg-[#1b2e4b]'>
                0.00
              </div>
              <input
                type='text'
          ...
          <div>
            <div className='flex'>
              ...
              />
              <div className='border-white-light flex items-center justify-center rounded-none border bg-[#eee] px-3 font-semibold dark:border-[#17263c] dark:bg-[#1b2e4b]'>
                0.00
              </div>
