        ...
        <form>
          <div className='dropdown mb-5'>
            ...
            <div className='flex'>
              <button
                type='button'
                className='border-info bg-info flex items-center justify-center border px-3 font-semibold text-white ltr:rounded-l-md ltr:border-r-0 rtl:rounded-r-md rtl:border-l-0'
              >
                Action
              </button>
              <div className='dropdown'>
              ...
              <input
                ...
                type='text'
                placeholder=''
                className='form-input ltr:rounded-l-none ltr:border-l-0 rtl:rounded-r-none rtl:border-r-0'
              />
            </div>
          </div>
          <div className='dropdown'>
            ...
            <div className='flex'>
              ...
              <button
                type='button'
                className='border-secondary bg-secondary flex cursor-pointer items-center justify-center border px-3 font-semibold text-white ltr:rounded-r-md ltr:border-l-0 rtl:rounded-l-md rtl:border-r-0'
              >
                Action
              </button>
            </div>
