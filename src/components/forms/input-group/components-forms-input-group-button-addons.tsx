        ...
        <form>
          ...
          <div className='mb-5'>
            ...
            <div className='flex'>
              <button
                type='button'
                className='btn btn-outline-info ltr:rounded-r-none rtl:rounded-l-none'
              >
                Button
              </button>
              <button
                type='button'
                className='btn btn-outline-info rounded-none ltr:border-l-0 rtl:border-r-0'
              >
                Button
              </button>
              <input
          ...
          <div>
            ...
            <div className='flex'>
              ...
              <button
                type='button'
                className='btn btn-outline-secondary ltr:rounded-l-none rtl:rounded-r-none'
              >
                Button
              </button>
            </div>
