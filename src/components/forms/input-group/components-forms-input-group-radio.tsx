    ...
    >
      <div className='mb-5'>
        <div className='mb-5'>
          ...
          <div className='flex'>
            <div className='border-white-light flex items-center justify-center border bg-[#f1f2f3] px-3 font-semibold ltr:rounded-l-md ltr:border-r-0 rtl:rounded-r-md rtl:border-l-0 dark:border-[#17263c] dark:bg-[#1b2e4b]'>
              <input
                type='radio'
                className='form-radio border-white-light text-info dark:border-white-dark ltr:mr-0 rtl:ml-0'
                defaultChecked
              />
            </div>
            <input
        ...
        <div>
          ...
          <div className='flex'>
            ...
            />
            <div className='border-white-light flex items-center justify-center border bg-[#f1f2f3] px-3 font-semibold ltr:rounded-r-md ltr:border-l-0 rtl:rounded-l-md rtl:border-r-0 dark:border-[#17263c] dark:bg-[#1b2e4b]'>
              <input
                type='radio'
                className='form-radio border-white-light text-danger dark:border-white-dark ltr:mr-0 rtl:ml-0'
                defaultChecked
              />
            </div>
          </div>
