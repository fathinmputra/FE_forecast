...
const ComponentsFormsWizardsSquareTextAndIcon = () => {
  const [activeTab6, setActiveTab6] = useState<number>(1);
  return (
    <PanelCodeHighlight
      title='Text & Icon'
      ...
      <div className='mb-5'>
        <div className='inline-block w-full'>
              ...
              className={`${
                activeTab6 === 1
                  ...
                  : ''
                                        ...
                                        bg-primary absolute top-[30px] -z-[1] m-auto h-1 w-[15%] transition-[width] ltr:left-0 rtl:right-0`}
            ></div>
            <ul className='mb-5 grid grid-cols-3'>
              <li className='mx-auto'>
                <button
                ...
                <span
                  className={`${
                    activeTab6 === 1 ? 'text-primary ' : ''
                  }text-center mt-2 block`}
                >
                  Home
                </span>
              </li>
          ...
          <div className='flex justify-between'>
            <button
              type='button'
              className={`btn btn-primary ${activeTab6 === 1 ? 'hidden' : ''}`}
              onClick={() => setActiveTab6(activeTab6 === 3 ? 2 : 1)}
            >
              Back
            </button>
            <button
              ...
              onClick={() => setActiveTab6(activeTab6 === 1 ? 2 : 3)}
            >
              {activeTab6 === 3 ? 'Finish' : 'Next'}
            </button>
          </div>
