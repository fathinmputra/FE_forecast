...
const ComponentsFormsWizardsSquareIcon = () => {
  const [activeTab5, setActiveTab5] = useState<number>(1);
  return (
    <PanelCodeHighlight
      title='Icon Only'
      ...
      <div className='mb-5'>
        <div className='inline-block w-full'>
          ...
          <div className='flex justify-between'>
            <button
              type='button'
              className={`btn btn-primary ${activeTab5 === 1 ? 'hidden' : ''}`}
              onClick={() => setActiveTab5(activeTab5 === 3 ? 2 : 1)}
            >
              Back
            </button>
            <button
              ...
              onClick={() => setActiveTab5(activeTab5 === 1 ? 2 : 3)}
            >
              {activeTab5 === 3 ? 'Finish' : 'Next'}
            </button>
          </div>
