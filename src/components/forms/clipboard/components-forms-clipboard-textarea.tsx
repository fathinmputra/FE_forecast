...
const [message2, setMessage2] = useState<string>('Lorem ipsum dolor sit amet, consectetur adipiscing elit...');
      ...
      <div className='mb-5'>
        <div className='rounded bg-[#f1f2f3] p-5 dark:bg-[#060818]'>
          <form>
            ...
            ></textarea>
            <div className='mt-5 space-y-2 sm:flex sm:space-x-2 sm:space-y-0 rtl:space-x-reverse'>
              <CopyToClipboard
                text={message2}
                onCopy={result => {
                  if (result) {
