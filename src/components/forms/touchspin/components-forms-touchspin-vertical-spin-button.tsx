...
const ComponentsFormsTouchspinVerticalSpinButton = () => {
  const [value8, setValue8] = useState<number>(0);
    ...
    >
      <div className='mb-5'>
        <div className='inline-flex w-[50px] flex-col'>
          <button
            type='button'
            className='border-primary bg-primary flex items-center justify-center rounded-t-md border border-b-0 p-3 font-semibold text-white'
            onClick={() => setValue8(value8 > 0 ? value8 - 1 : 0)}
          >
          ...
          <button
            type='button'
            className='border-primary bg-primary flex items-center justify-center rounded-b-md border border-t-0 p-3 font-semibold text-white'
            onClick={() => setValue8(value8 < 100 ? value8 + 1 : 100)}
          >
            <IconPlus />
          </button>
