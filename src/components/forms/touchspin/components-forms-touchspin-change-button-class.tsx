...
const ComponentsFormsTouchspinChangeButtonClass = () => {
  const [value10, setValue10] = useState<number>(0);
  return (
    <PanelCodeHighlight
      ...
      <div className='mb-5'>
        <div className='relative'>
          <div className='flex'>
            <button
              type='button'
              className='border-danger bg-danger flex items-center justify-center border border-r-0 px-3 font-semibold text-white ltr:rounded-l-md rtl:rounded-r-md'
              onClick={() => setValue10(value10 > 0 ? value10 - 1 : 0)}
            >
            ...
            <button
              type='button'
              className='border-warning bg-warning flex items-center justify-center border border-l-0 px-3 font-semibold text-white ltr:rounded-r-md rtl:rounded-l-md'
              onClick={() => setValue10(value10 < 100 ? value10 + 1 : 100)}
            >
              <IconPlus />
            </button>
