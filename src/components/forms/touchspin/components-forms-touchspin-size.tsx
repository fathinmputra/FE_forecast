...
const ComponentsFormsTouchspinSize = () => {
  ...
  const [value5, setValue5] = useState<number>(0);
  const [value6, setValue6] = useState<number>(0);
      ...
      <div className='mb-5'>
        <div className='mb-5'>
          ...
          <div className='flex'>
            <button
              type='button'
              className='border-primary bg-primary flex items-center justify-center border border-r-0 px-3 font-semibold text-white ltr:rounded-l-md rtl:rounded-r-md'
              onClick={() => setValue4(value4 > 0 ? value4 - 1 : 0)}
            >
            ...
            <input
              ...
              type='number'
              placeholder='55'
              className='form-input-lg form-input rounded-none text-center'
              min='0'
              max='25'
              readOnly
              value={value4}
            ...
            <button
              type='button'
              className='border-primary bg-primary flex items-center justify-center border border-l-0 px-3 font-semibold text-white ltr:rounded-r-md rtl:rounded-l-md'
              onClick={() => setValue4(value4 < 100 ? value4 + 1 : 100)}
            >
              <IconPlus />
            </button>
        ...
        <div>
          ...
          <div className='flex'>
            ...
            <input
              ...
              type='number'
              placeholder='55'
              className='form-input-sm form-input rounded-none text-center'
              min='0'
              max='25'
              readOnly
              value={value6}
