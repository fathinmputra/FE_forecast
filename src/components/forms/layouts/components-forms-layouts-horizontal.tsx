        ...
        <form className='space-y-5'>
          <div className='flex flex-col sm:flex-row'>
            <label
              ...
              className='mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2'
            >
              Email
            </label>
            <input
          ...
          <div className='flex flex-col sm:flex-row'>
            <label className='sm:w-1/4 sm:ltr:mr-2 rtl:ml-2'>
              Choose Segements
            </label>
            <div className='flex-1'>
              <div className='mb-2'>
          ...
          <div className='flex flex-col sm:flex-row'>
            <label className='font-semibold sm:w-1/4 sm:ltr:mr-2 rtl:ml-2'>
              Apply
            </label>
