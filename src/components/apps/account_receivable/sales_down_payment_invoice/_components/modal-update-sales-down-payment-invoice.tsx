...
import { useUpdateSalesDownPaymentInvoice } from '@/app/api/hooks/account_receivable/sales_down_payment_invoice/useUpdateSalesDownPaymentInvoice';
...
const ModalUpdateSalesInvoice = ({
  ...
  const updateSalesInvoice = useUpdateSalesDownPaymentInvoice();
    ...
    if (invoiceData) {
      setForm({
        ...
        due_date: invoiceData.due_date
          ...
          : undefined,
        dispatched_date: invoiceData.dispatched_date
          ? new Date(invoiceData.dispatched_date)
          : undefined,
            ...
            <Dialog.Panel className='my-8 w-full max-w-4xl overflow-hidden rounded-lg bg-white p-6 shadow-lg'>
              <div className='flex items-center justify-between border-b p-5 text-black'>
                <h5 className='text-lg font-bold'>
                  Update Sales Dowwn Payyment Invoice
                </h5>
                <button
