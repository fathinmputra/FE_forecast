...
const PurchaseInvoiceDetailComponent = ({ data }: IPurchaseInvoiceDetail) => {
  const {
    invoice_number,
    purchase_order_code,
    total,
      ...
      {purchaseOrder && (
        <div className='mb-5 px-5'>
          ...
          <div className='mb-5 flex flex-col gap-5 md:flex-row md:items-center'>
            ...
            <div className='w-full'>
              <label htmlFor='supplier_phone_number'>
              ...
              <tbody>
                {purchaseOrder.PurchaseDetails.map((detail, index) => (
                  <tr key={detail.pkid}>
                    ...
                    <td>
                      {formatCurrencyDisplay(detail.price, currency_code)}
                    </td>
                    <td>
...
export default PurchaseInvoiceDetailComponent;
