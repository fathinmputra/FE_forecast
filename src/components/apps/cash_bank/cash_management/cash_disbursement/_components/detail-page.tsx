...
const CashDisbursementDetailComponent = ({ data }: ICashDisbursementDetail) => {
  if (!data) {
    ...
    <div className='panel border-white-light h-full px-0 pb-10'>
      ...
      <div className='mt-6 px-5'>
        ...
        <table className='table-striped'>
          ...
          <tbody>
            {details.map(
              (detail: CashDisbursementDetailProperty, index: number) => (
                <tr key={index}>
                  <td>{index + 1}</td>
...
export default CashDisbursementDetailComponent;
