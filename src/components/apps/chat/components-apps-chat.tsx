...
const contactList = [
  ...
  },
  {
    ...
    path: 'profile-5.jpeg',
    time: '2:00 PM',
    preview: 'Whats up for the third time like is you bling bitch',
    messages: [
      {
        fromUserId: 0,
        toUserId: 6,
...
const ComponentsAppsChat = () => {
  ...
  const scrollToBottom = () => {
    if (isShowUserChat) {
      setTimeout(() => {
        ...
        if (element) {
          (element as HTMLElement).scrollTop = element.scrollHeight;
        }
      });
    }
  };
  ...
  const sendMessage = () => {
    if (textMessage.trim() && selectedUser) {
      ...
      const userIndex = list.findIndex(d => d.userId === selectedUser.userId);
      if (userIndex !== -1) {
      ...
      >
        ...
        >
          ...
          <div className='relative'>
            ...
            />
            <div className='peer-focus:text-primary absolute top-1/2 -translate-y-1/2 ltr:right-2 rtl:left-2'>
              <IconSearch />
            </div>
          </div>
              ...
              {filteredItems.map((person: Contact) => {
                return (
                  <div key={person.userId}>
                    <button
                      type='button'
                      className={`hover:text-primary dark:hover:text-primary flex w-full items-center justify-between rounded-md p-2 hover:bg-gray-100 dark:hover:bg-[#050b14] ${
          ...
          {!isShowUserChat && (
            <div className='relative flex h-full items-center justify-center p-4'>
              <button
                type='button'
                onClick={() => setIsShowChatMenu(!isShowChatMenu)}
                className='hover:text-primary absolute top-4 xl:hidden ltr:left-4 rtl:right-4'
              >
                <IconMenu />
              </button>
              ...
              <div className='flex items-center justify-between p-4'>
                <div className='flex items-center space-x-2 rtl:space-x-reverse'>
                  ...
                  <div className='relative flex-none'>
                    <div className='relative h-10 w-10 rounded-full object-cover sm:h-12 sm:w-12'>
                      <Image
                ...
                <div className='flex gap-3 sm:gap-5'>
                  ...
                  <button type='button'>
                    <IconVideo className='hover:text-primary h-5 w-5' />
                  </button>
                  <div className='dropdown'>
                    <Dropdown
                      placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                    ...
                    >
                      <ul className='dark:text-white-dark text-black'>
                        <li>
                          <button type='button'>
              ...
              <div className='absolute bottom-0 left-0 w-full p-4'>
                <div className='w-full items-center space-x-3 sm:flex rtl:space-x-reverse'>
                  <div className='relative flex-1'>
                    ...
                    <button
                      type='button'
                      className='hover:text-primary absolute top-1/2 -translate-y-1/2 ltr:left-4 rtl:right-4'
                    >
                      <IconMoodSmile />
                    </button>
                    <button
                      type='button'
                      className='hover:text-primary absolute top-1/2 -translate-y-1/2 ltr:right-4 rtl:left-4'
                      onClick={() => sendMessage()}
                    >
                      <IconSend />
                    </button>
