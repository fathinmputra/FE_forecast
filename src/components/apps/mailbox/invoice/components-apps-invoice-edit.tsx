...
const ComponentsAppsInvoiceEdit = () => {
  ...
  const removeItem = (item: Item | null = null) => {
    if (item) {
  ...
  const changeQuantityPrice = (type: string, value: string, id: number) => {
    const updatedItems = items.map(item => {
      if (item.id === id) {
        return {
          ...item,
          quantity: type === 'quantity' ? Number(value) : item.quantity,
          amount: type === 'price' ? Number(value) : item.amount,
        };
      }
      return item;
    });
  ...
  return (
    <div className='flex flex-col gap-2.5 xl:flex-row'>
      <div className='panel flex-1 px-0 py-6 ltr:xl:mr-6 rtl:xl:ml-6'>
        <div className='flex flex-wrap justify-between px-4'>
          <div className='mb-6 w-full lg:w-1/2'>
            ...
            <div className='mt-6 space-y-1 text-gray-500 dark:text-gray-400'>
              <div>13 Tetris Road, Cypress Gardens, Florida, 33884, US</div>
        ...
        <hr className='border-white-light my-6 dark:border-[#1b2e4b]' />
                  ...
                  <tr className='align-top' key={item.id}>
                    <td>
                      <input
                        ...
                        onChange={e =>
                          changeQuantityPrice('title', e.target.value, item.id)
                        }
                      />
                      <textarea
                    ...
                    <td>
                      <input
                        ...
                        min={0}
                        onChange={e =>
                          changeQuantityPrice('price', e.target.value, item.id)
                        }
                      />
                    </td>
      ...
      <div className='mt-6 w-full xl:mt-0 xl:w-96'>
        ...
        <div className='panel'>
          <div className='grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-1'>
            ...
            <Link
              href='src/app/(dashboard)/apps/invoice/preview'
