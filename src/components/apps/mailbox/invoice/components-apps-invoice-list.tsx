...
const initialSortStatus: DataTableSortStatus = {
...
const ComponentsAppsInvoiceList = () => {
  ...
  const [initialRecords, setInitialRecords] = useState<InvoiceItem[]>(
      ...
      <div className='invoice-table'>
        <div className='mb-4.5 flex flex-col gap-5 px-5 md:flex-row md:items-center'>
          <div className='flex items-center gap-2'>
            ...
            <Link
              href='src/app/(dashboard)/apps/invoice/add'
        ...
        <div className='datatables pagination-padding'>
          <DataTable
            ...
            //         <div className='text-primary font-semibold underline hover:no-underline'>{`#${invoice}`}</div>
            //       </Link>
            //     ),
            //   },
            //   {
            ...
            //         <div className='bg-white-dark/30 w-max rounded-full p-0.5 ltr:mr-2 rtl:ml-2'>
            //           <img
            ...
            //           className='hover:text-info flex'
            //         >
            ...
            //         <button
            //           type='button'
            //           className='hover:text-danger flex'
