...
interface IModalNewItemProps {
  modal: boolean;
  setModal: (value: boolean) => void;
  refetch: () => void;
}

const ModalNewItem = ({ modal, setModal, refetch }: IModalNewItemProps) => {
  ...
  const mandatoryValidation = () => {
    ...
    const excludeItemField = ['pkid', 'code', 'description'];
                ...
                <div className='space-y-5'>
                      ...
                      <Select
                        ...
                        value={
                          categoryDropdown.find(
                            item => item.value == form.category_id?.toString(),
                          ) || categoryDropdown[0]
                        }
                      />
                    </div>
                  ...
                  <div className='grid w-full grid-cols-7 gap-2'>
                    ...
                    <div className='col-span-2'>
                      ...
                      <Select
                        ...
                        value={
                          unitDropdown.find(
                            item => item.value == form.unit_id?.toString(),
                          ) || unitDropdown[0]
                        }
                      />
                    </div>
                  ...
                  <div className='col-span-2'>
                    ...
                    <Select
                      ...
                      value={
                        taxDropdown.find(
                          item => item.value == form.tax_id?.toString(),
                        ) || taxDropdown[0]
                      }
                    />
                  </div>
