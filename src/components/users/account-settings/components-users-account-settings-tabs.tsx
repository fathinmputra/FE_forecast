...
const ComponentsUsersAccountSettingsTabs = () => {
  ...
  return (
    <div className='pt-5'>
      ...
      <div>
        <ul className='mb-5 overflow-y-auto whitespace-nowrap border-b border-[#ebedf2] font-semibold sm:flex dark:border-[#191e3a]'>
          <li className='inline-block'>
            <button
              onClick={() => toggleTabs('home')}
              className={`hover:border-primary hover:text-primary flex gap-2 border-b border-transparent p-4 ${
          ...
          <div className='mb-5 grid grid-cols-1 gap-5 lg:grid-cols-2'>
            <div className='panel'>
              <div className='mb-5'>
                ...
                <p>
                  Changes to your <span className='text-primary'>Billing</span>{' '}
                  information will take effect starting with scheduled payment
                  and will be reflected on your next invoice.
                </p>
              </div>
              <div className='mb-5'>
                <div className='border-b border-[#ebedf2] dark:border-[#1b2e4b]'>
                  <div className='flex items-start justify-between py-3'>
                    <h6 className='dark:text-white-dark text-[15px] font-bold text-[#515365]'>
                      Address #1
                      <span className='text-white-dark dark:text-white-light mt-1 block text-xs font-normal'>
                        2249 Caynon Circle, New Brunswick, New Jersey
                      </span>
                    </h6>
          ...
          <div className='grid grid-cols-1 gap-5 lg:grid-cols-2'>
            <div className='panel'>
              <div className='mb-5'>
                ...
                <p>
                  Changes your New <span className='text-primary'>Billing</span>{' '}
                  Information.
                </p>
              </div>
              <div className='mb-5'>
        ...
        <div className='switch'>
          ...
          <div className='grid grid-cols-1 gap-5 md:grid-cols-3'>
            <div className='panel space-y-5'>
              ...
              <label
                htmlFor='custom_switch_checkbox1'
            ...
            <div className='panel space-y-5'>
              ...
              <label
                htmlFor='custom_switch_checkbox3'
                className='relative h-6 w-12'
              >
                <input
                  type='checkbox'
            ...
            <div className='panel space-y-5'>
              ...
              <p>
                Sidebar will be <span className='text-primary'>hidden</span> by
                default
              </p>
