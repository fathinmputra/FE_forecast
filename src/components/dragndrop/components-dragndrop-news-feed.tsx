            ...
            {newsFeed.map(item => {
              return (
                <div className='mb-2.5' key={item.id}>
                  <div className='border-white-light dark:border-dark rounded-md border bg-white px-6 py-3.5 dark:bg-[#1b2e4b]'>
                    <div className='py-sm-2.5 items-md-center block text-center sm:flex ltr:md:text-left rtl:md:text-right'>
                      <div className='ltr:sm:mr-4 rtl:sm:ml-4'>
                        <Image
                          alt='avatar'
                          src={`/assets/images/profile-${item.id + 1}.jpeg`}
                    ...
                    <div className='dark:border-b-dark mb-4 border-b border-b-[#f1f2f3] py-5'>
                    ...
                    <div className='flex-wrap items-center md:flex'>
                      <div className='text-center xl:flex-1 ltr:md:text-left rtl:md:text-right'>
                        <div className='flex justify-center -space-x-2 text-white md:justify-start rtl:space-x-reverse'>
                          <Image
                            className='dark:ring-white-dark h-10 w-10 rounded-full object-cover ring-2 ring-white'
                      ...
                      <div className='text-center ltr:md:text-right rtl:md:text-left'>
                        <span className='text-white-dark block pt-2 text-xs lg:pt-0'>
                          <button className='text-danger dark:text-primary mr-1 text-sm font-semibold'>
                            Vincent, Mary
                          </button>
