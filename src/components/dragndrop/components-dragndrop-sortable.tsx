              ...
              {sortable1.map(item => {
                return (
                  <li key={item.id} className='mb-2.5 cursor-grab'>
                    <div className='items-md-center border-white-light dark:border-dark flex flex-col rounded-md border bg-white px-6 py-3.5 text-center md:flex-row ltr:md:text-left rtl:md:text-right dark:bg-[#1b2e4b]'>
