...
import React, { ChangeEvent, Fragment, ReactElement, useEffect, useMemo, useState } from 'react';
...
const RenderPlainDataTable = <T extends MyData>({
  title,
  data,
  columns,
  isLoading,
...
IProps<T>) => {
  ...
  // learn about the differenece of setInitialRecords with setRecordsData
  useEffect(() => {
    if (data && columns) {
      setInitialRecords(
  ...
  // learn about the delete function
...
export default RenderPlainDataTable;
