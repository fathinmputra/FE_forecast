  ...
  return (
    ...
    <div className="max-w-[320px] md:max-w-[1140px] mx-auto dark:text-white-dark">
        <div className="mt-5 md:mt-10 text-center flex justify-center space-x-4 rtl:space-x-reverse font-semibold text-base">
           ...
           <label htmlFor="custom_switch_checkbox1" className="w-12 h-6 relative inline-block">
              <input
    ...
    >
      <div className='mb-5'>
        <div className='dark:text-white-dark mx-auto max-w-[320px] md:max-w-[1140px]'>
          <div className='mt-5 flex justify-center space-x-4 text-center text-base font-semibold md:mt-10 rtl:space-x-reverse'>
            <span
            ...
            />
            <span className='outline_checkbox bg-icon dark:border-white-dark dark:before:bg-white-dark peer-checked:border-primary peer-checked:before:bg-primary block h-full rounded-full border-2 border-[#ebedf2] before:absolute before:bottom-1 before:h-4 before:w-4 before:rounded-full before:bg-[#ebedf2] before:bg-[url(/assets/images/close.svg)] before:bg-center before:bg-no-repeat before:transition-all before:duration-300 peer-checked:before:bg-[url(/assets/images/checked.svg)] ltr:before:left-1 ltr:peer-checked:before:left-7 rtl:before:right-1 rtl:peer-checked:before:right-7'></span>
            <span
              className={`relative ${
                yearlyPrice ? 'text-primary' : ' text-white-dark'
              }  `}
            >
              Yearly{' '}
              <span className='badge bg-success absolute my-auto hidden whitespace-nowrap rounded-full ltr:left-full ltr:ml-2 rtl:right-full rtl:mr-2'>
                20% Off
              </span>
            </span>
          </div>
          <div className='text-white-dark mt-5 space-y-4 md:mt-16 md:flex md:space-y-0'>
            <div className='border-white-light rounded-md border p-4 transition-all duration-300 hover:shadow-[0_0_15px_1px_rgba(113,106,202,0.20)] lg:p-9 ltr:md:rounded-r-none ltr:md:border-r-0 rtl:md:rounded-l-none rtl:md:border-l-0 dark:border-[#1b2e4b]'>
              <h3 className='dark:text-white-light mb-5 text-xl font-semibold text-black'>
                Cloud Hosting
              </h3>
              <p>cPanel/WHM included. Intel Xeon E3 with guaranteed 2GB RAM.</p>
              <div className='my-7 p-2.5 text-center text-lg'>
                <strong className='dark:text-white-light text-xl text-[#3b3f5c] lg:text-3xl'>
                  $25
                </strong>{' '}
                / monthly
              </div>
              <div className='mb-6'>
                <strong className='dark:text-white-light mb-3 inline-block text-[15px] text-black'>
            ...
            <div className='border-white-light relative rounded-t-md border p-4 pt-14 transition-all duration-300 lg:p-9 dark:border-[#1b2e4b]'>
            ...
            <div className='border-white-light rounded-md border p-4 transition-all duration-300 hover:shadow-[0_0_15px_1px_rgba(113,106,202,0.20)] lg:p-9 ltr:md:rounded-l-none ltr:md:border-l-0 rtl:md:rounded-r-none rtl:md:border-r-0 dark:border-[#1b2e4b]'>
              <h3 className='dark:text-white-light mb-5 text-xl font-semibold text-black'>
                Business Hosting
              </h3>
              <p>cPanel/WHM included. Intel Xeon E5 with guaranteed 8GB RAM.</p>
