...
<div className="mb-5 grid grid-cols-3 justify-items-center gap-3 max-w-[900px] mx-auto">
    ...
    >
      <div className='mx-auto mb-5 grid max-w-[900px] grid-cols-3 justify-items-center gap-3'>
        <div>
          <div className='border-white-light flex h-[70px] w-[70px] flex-col justify-center rounded-full border shadow-[1px_2px_12px_0_rgba(31,45,61,0.10)] sm:h-[100px] sm:w-[100px] dark:border-[#1b2e4b]'>
            <CountUp
              start={0}
              end={105}
              duration={7}
              className='text-primary text-center text-xl sm:text-3xl'
            />
          </div>
          <h4 className='dark:text-white-dark mt-4 text-center text-xs font-semibold text-[#3b3f5c] sm:text-[15px]'>
            <IconUsers className='text-primary mx-auto mb-2 sm:h-6 sm:w-6' />
            Clients
          </h4>
        </div>
        <div>
          ...
          <h4 className='dark:text-white-dark mt-4 text-center text-xs font-semibold text-[#3b3f5c] sm:text-[15px]'>
            <IconCloudDownload className='text-primary mx-auto mb-2 sm:h-6 sm:w-6' />
            Downloads
          </h4>
        </div>
        <div>
          ...
          <h4 className='dark:text-white-dark mt-4 text-center text-xs font-semibold text-[#3b3f5c] sm:text-[15px]'>
            <IconAward className='text-primary mx-auto mb-2 sm:h-6 sm:w-6' />
            Awards
          </h4>
        </div>
      </div>
