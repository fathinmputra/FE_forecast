...
<div className="mb-5 grid grid-cols-3 justify-items-center gap-3 max-w-[900px] mx-auto">
    ...
    >
      <div className='mx-auto mb-5 grid max-w-[900px] grid-cols-3 justify-items-center gap-3'>
        <div>
          <div className='border-white-light flex h-[70px] w-[70px] flex-col justify-center rounded border shadow-[1px_2px_12px_0_rgba(31,45,61,0.10)] sm:h-[100px] sm:w-[100px] dark:border-[#1b2e4b]'>
            <CountUp
              start={0}
              end={710}
              duration={7}
