                  ...
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    ...
                    >
                      <Dialog.Panel className='panel dark:text-white-dark my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black'>
                        <div className='dark:text-white-dark/70 flex items-center justify-center p-5 text-base font-medium text-[#1f2937]'>
                        ...
                        <div className='p-5'>
                          <div className='text-white-dark text-center text-sm'>
                            <p>
                              Vivamus vitae hendrerit neque. Orci varius natoque
                              penatibus et magnis dis parturient montes,
                              nascetur ridiculus mus. Morbi consequat auctor
                              turpis, vitae dictum augue efficitur vitae.
                              Vestibulum a risus ipsum. Quisque nec lacus dolor.
                              Quisque ornare tempor orci id rutrum.
                            </p>
                          </div>
                        ...
                        <div className='p-5'>
                          <Tab.Group>
                            <Tab.List className='border-white-light mt-3 flex flex-wrap border-b dark:border-[#191e3a]'>
                              ...
                              <Tab className='text-white-light dark:text-dark pointer-events-none -mb-[1px] block p-3.5 py-2 outline-none'>
                                Disabled
                              </Tab>
                            </Tab.List>
                            <Tab.Panels className='text-sm'>
                ...
                >
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Transition.Child
                      ...
                      leaveTo='opacity-0 scale-95'
                    >
                      <Dialog.Panel className='panel bg-secondary dark:bg-secondary dark:text-white-dark my-8 w-full max-w-[300px] overflow-hidden rounded-lg border-0 p-0 text-black'>
                        <div className='dark:text-white-light flex items-center justify-end pt-4 text-white ltr:pr-4 rtl:pl-4'>
                          <button
                        ...
                        <div className='p-5'>
                          <div className='dark:text-white-light py-5 text-center text-white'>
                ...
                >
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Transition.Child
                      ...
                      leaveTo='opacity-0 scale-95'
                    >
                      <Dialog.Panel className='panel dark:text-white-dark my-8 w-full max-w-sm overflow-hidden rounded-lg border-0 px-4 py-1 text-black'>
                        ...
                        <div className='p-5'>
                          <form>
                            <div className='relative mb-4'>
                              <span className='dark:text-white-dark absolute top-1/2 -translate-y-1/2 ltr:left-3 rtl:right-3'>
                        ...
                        <div className='text-white-dark dark:text-white-dark/70 my-4 text-center text-xs'>
                          OR
                        </div>
                        ...
                        <div className='border-t border-[#ebe9f1] p-5 dark:border-white/10'>
                          <p className='text-white-dark dark:text-white-dark/70 text-center text-sm'>
                            Looking to
                            <button
                              type='button'
                              className='dark:text-white-dark text-[#515365] hover:underline ltr:ml-1 rtl:mr-1'
                            >
                              create an account?
                            </button>
                          </p>
                ...
                <div className='flex min-h-screen items-start justify-center px-4'>
                  <Dialog.Panel className='animate__animated animate__fadeIn panel my-8 w-full max-w-xl overflow-hidden rounded-lg border-0 px-4 py-1'>
                    ...
                    >
                      ...
                      <button
                        type='button'
                        className='swiper-button-prev-ex1 border-primary text-primary hover:border-primary hover:bg-primary absolute top-1/2 z-[999] grid -translate-y-1/2 place-content-center  rounded-full border p-1 transition hover:text-white ltr:left-2 rtl:right-2'
                      >
                        <IconCaretDown className='h-5 w-5 rotate-90 rtl:-rotate-90' />
                      </button>
                      <button
                        type='button'
                        className='swiper-button-next-ex1 border-primary text-primary hover:border-primary hover:bg-primary absolute top-1/2 z-[999] grid -translate-y-1/2 place-content-center rounded-full border p-1 transition hover:text-white ltr:right-2 rtl:left-2'
                      >
                        <IconCaretDown className='h-5 w-5 -rotate-90 rtl:rotate-90' />
                      </button>
                      <div className='swiper-pagination'></div>
