              ...
              <Dialog as='div' open={modal9} onClose={() => setModal9(false)}>
                ...
                >
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Dialog.Panel className='panel animate__animated animate__fadeIn dark:text-white-dark my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black'>
          ...
          <div>
            ...
            <Transition appear show={modal10} as={Fragment}>
              <Dialog as='div' open={modal10} onClose={() => setModal10(false)}>
                ...
                >
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Dialog.Panel className='panel animate__animated animate__slideInDown dark:text-white-dark my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black'>
                      <div className='flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]'>
                        <h5 className='text-lg font-bold'>Modal Title</h5>
                        <button
          ...
          <div>
            ...
            <Transition appear show={modal11} as={Fragment}>
              <Dialog as='div' open={modal11} onClose={() => setModal11(false)}>
                ...
                >
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Dialog.Panel className='panel animate__animated animate__fadeInUp dark:text-white-dark my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black'>
                      <div className='flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]'>
                        <h5 className='text-lg font-bold'>Modal Title</h5>
                        <button
          ...
          <div>
            ...
            <Transition appear show={modal12} as={Fragment}>
              <Dialog as='div' open={modal12} onClose={() => setModal12(false)}>
                ...
                >
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Dialog.Panel className='panel animate__animated animate__slideInUp dark:text-white-dark my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black'>
                      <div className='flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]'>
                        <h5 className='text-lg font-bold'>Modal Title</h5>
                        <button
            ...
            <Transition appear show={modal13} as={Fragment}>
              <Dialog as='div' open={modal13} onClose={() => setModal13(false)}>
                ...
                >
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Dialog.Panel
                      className={`panel animate__animated dark:text-white-dark my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black ${
          ...
          <div>
            ...
            <Transition appear show={modal16} as={Fragment}>
              <Dialog as='div' open={modal16} onClose={() => setModal16(false)}>
                ...
                >
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Dialog.Panel className='panel animate__animated animate__zoomInUp dark:text-white-dark my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black'>
                      <div className='flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]'>
                        <h5 className='text-lg font-bold'>Modal Title</h5>
                        <button
