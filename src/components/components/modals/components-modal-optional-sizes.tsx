                ...
                <div className='fixed inset-0 z-[999] bg-[black]/60'>
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Transition.Child
                      ...
                      leaveTo='opacity-0 scale-95'
                    >
                      <Dialog.Panel className='panel dark:text-white-dark my-8 w-full max-w-5xl overflow-hidden rounded-lg border-0 p-0 text-black'>
                        ...
                        <div className='p-5'>
                          <p>
                            ...
                            Suspendisse potenti. Vivamus ultrices sed urna ac
                            pulvinar. Ut sit amet ullamcorper mi.
                          </p>
                ...
                <div className='fixed inset-0 z-[999] bg-[black]/60'>
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Transition.Child
                      ...
                      leaveTo='opacity-0 scale-95'
                    >
                      <Dialog.Panel className='panel dark:text-white-dark my-8 w-full max-w-xl  overflow-hidden rounded-lg border-0 p-0 text-black'>
                        <div className='flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]'>
                          <h5 className='text-lg font-bold'>Modal Title</h5>
                          <button
                ...
                <div className='fixed inset-0 z-[999] overflow-y-auto bg-[black]/60'>
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Transition.Child
                      ...
                      leaveTo='opacity-0 scale-95'
                    >
                      <Dialog.Panel className='panel dark:text-white-dark my-8 w-full max-w-sm  overflow-hidden rounded-lg border-0 p-0 text-black'>
                        <div className='flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]'>
                          <h5 className='text-lg font-bold'>Modal Title</h5>
                          <button
