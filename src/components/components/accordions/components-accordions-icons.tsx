      ...
      <div className='mb-5'>
        <div className='space-y-2 font-semibold'>
          <div className='rounded border border-[#d3d3d3] dark:border-[#1b2e4b]'>
            <button
              type='button'
              className={`text-white-dark flex w-full items-center p-4 dark:bg-[#1b2e4b] ${
                active2 === '1' ? '!text-primary' : ''
              }`}
              onClick={() => togglePara2('1')}
            >
              <IconAirplay className='text-primary shrink-0 ltr:mr-2 rtl:ml-2' />
              Collapsible Group Item #1
              <div
            ...
            <div>
              ...
              >
                <div className='text-white-dark space-y-2 border-t border-[#d3d3d3] p-4 text-[13px] dark:border-[#1b2e4b]'>
                  <p>
          ...
          <div className='rounded border border-[#d3d3d3] dark:border-[#1b2e4b]'>
            <button
              ...
              onClick={() => togglePara2('2')}
            >
              <IconBox className='text-primary shrink-0 ltr:mr-2 rtl:ml-2' />
              Collapsible Group Item #2
              <div
                className={`ltr:ml-auto rtl:mr-auto ${
          ...
          <div className='rounded border border-[#d3d3d3] dark:border-[#1b2e4b]'>
            <button
              ...
              onClick={() => togglePara2('3')}
            >
              <IconLayout className='text-primary shrink-0 ltr:mr-2 rtl:ml-2' />
              Collapsible Group Item #3
              <div
                className={`ltr:ml-auto rtl:mr-auto ${
