  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className='swiper-button-prev-ex2 border-primary text-primary hover:border-primary hover:bg-primary absolute top-1/2 z-[999] grid -translate-y-1/2 place-content-center  rounded-full border p-1 transition hover:text-white ltr:left-2 rtl:right-2'>
          <IconCaretDown className='h-5 w-5 rotate-90 rtl:-rotate-90' />
        </button>
        <button className='swiper-button-next-ex2 border-primary text-primary hover:border-primary hover:bg-primary absolute top-1/2 z-[999] grid -translate-y-1/2 place-content-center  rounded-full border p-1 transition hover:text-white ltr:right-2 rtl:left-2'>
          <IconCaretDown className='h-5 w-5 -rotate-90 rtl:rotate-90' />
        </button>
      </Swiper>
    </PanelCodeHighlight>
