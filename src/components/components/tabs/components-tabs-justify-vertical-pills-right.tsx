...
<div className="mb-5 flex flex-col sm:flex-row">
    ...
    >
      <div className='mb-5 flex flex-col sm:flex-row sm:gap-4'>
        {isMounted && (
          <Tab.Group>
            <div className='mb-5 space-y-2 sm:order-1 sm:mb-0 sm:flex-[0_0_20%] ltr:pr-4 rtl:pl-4'>
                    ...
                    <button
                      className={`${
                        selected ? '!bg-success text-white !outline-none' : ''
                                                    ...
                                                    hover:bg-success block w-full rounded-md p-3.5 py-2 text-left transition-all duration-300  hover:text-white`}
                    >
                      Home
                    </button>
                  )}
