                  ...
                  <button
                    className={`${
                      selected ? '!bg-info text-white !outline-none' : ''
                                                    ...
                                                    hover:!bg-info flex h-16 w-16 flex-col items-center justify-center rounded-full bg-[#f1f2f3] transition-all duration-300 hover:text-white hover:shadow-[0_5px_15px_0_rgba(0,0,0,0.30)] dark:bg-[#191e3a]`}
                  >
