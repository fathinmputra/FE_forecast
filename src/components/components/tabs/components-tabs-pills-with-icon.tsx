...
<div className="mb-5 flex flex-col sm:flex-row">
    ...
    >
      <div className='mb-5'>
        {isMounted && (
          <Tab.Group>
            <Tab.List className='mb-5 mt-3 grid grid-cols-4 gap-2 sm:flex sm:flex-wrap sm:justify-center sm:space-x-3 rtl:space-x-reverse'>
              <Tab as={Fragment}>
                {({ selected }) => (
                  <button
                    className={`${
                      selected ? '!bg-success text-white !outline-none' : ''
                                                    ...
                                                    hover:!bg-success flex flex-col items-center justify-center rounded-lg bg-[#f1f2f3] p-7 py-3 hover:text-white hover:shadow-[0_5px_15px_0_rgba(0,0,0,0.30)] dark:bg-[#191e3a]`}
                  >
