              ...
              <Tab as={Fragment}>
                {({ selected }) => (
                  <button
                    className={`${
                      selected
                        ? '!border-secondary text-secondary border-b !outline-none'
                        : ''
                    }
                                                    hover:!border-secondary hover:text-secondary -mb-[1px] flex items-center border-transparent p-5 py-3 before:inline-block hover:border-b`}
                  >
