      ...
      <div className='mb-5'>
        {isMounted && (
          <Tab.Group>
              ...
              <Tab as={Fragment}>
                {({ selected }) => (
                  <button
                    className={`${
                      selected
                        ? '!border-white-light text-danger !border-b-white dark:!border-[#191e3a] dark:!border-b-black'
                        : ''
                    }
                                                hover:text-danger -mb-[1px] flex items-center border border-transparent p-3.5 py-2 !outline-none transition duration-300`}
                  >
            ...
            <Tab.Panels className='border-white-light flex-1 border border-t-0 p-4 text-sm  dark:border-[#191e3a]'>
              <Tab.Panel>
...
export default ComponentsTabsBorder;
