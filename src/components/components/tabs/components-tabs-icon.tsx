...
<Tab.Panels>
    ...
    >
      <div className='mb-5'>
        {isMounted && (
          <Tab.Group>
            <Tab.List className='border-white-light mr-3 mt-3 flex flex-wrap border-b dark:border-[#191e3a]'>
              <Tab as={Fragment}>
                {({ selected }) => (
                  <button
                    className={`${
                      selected
                        ? '!border-white-light text-danger !border-b-white !outline-none dark:!border-[#191e3a] dark:!border-b-black'
                        : ''
                    }
                                                hover:text-danger -mb-[1px] flex items-center border border-transparent p-3.5 py-2 dark:hover:border-b-black`}
                  >
              ...
              <Tab className='text-white-light dark:text-dark pointer-events-none -mb-[1px] flex items-center p-3.5 py-2'>
