        ...
        {isMounted && (
          <Tab.Group>
                      ...
                      className={`${
                        selected
                          ...
                          : ''
                                                    ...
                                                    border-white-light before:bg-secondary hover:text-secondary relative -mb-[1px] block w-full p-3.5 py-4 before:absolute before:bottom-0 before:top-0 before:m-auto before:inline-block before:h-0 before:w-[1px] before:transition-all before:duration-700 hover:before:h-[80%] ltr:border-r ltr:before:-right-[1px] rtl:border-l rtl:before:-left-[1px] dark:border-[#191e3a]`}
                    >
                      Home
                    </button>
                  )}
            ...
            <Tab.Panels>
              ...
              <Tab.Panel>
                <div className='border-white-light !border-l-primary rounded-br-md rounded-tr-md border border-l-2 bg-white p-5 text-black shadow-md ltr:pl-3.5 rtl:pr-3.5 dark:border-[#060818] dark:bg-[#060818]'>
                  <div className='flex items-start'>
                    <p className='dark:text-white-dark m-0 text-sm not-italic text-[#515365]'>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                      sed do eiusmod tempor incididunt ut labore et dolore magna
                      aliqua. Ut enim ad minim veniam, quis nostrud exercitation
