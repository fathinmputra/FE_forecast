                    ...
                    className={`${
                      selected
                        ...
                        : ''
                                                    ...
                                                    before:bg-secondary hover:text-secondary relative -mb-[1px] flex items-center p-5 py-3 before:absolute before:bottom-0 before:left-0 before:right-0 before:m-auto before:inline-block before:h-[1px] before:w-0 before:transition-all before:duration-700 hover:before:w-full`}
                  >
