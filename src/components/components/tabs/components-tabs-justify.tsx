                    ...
                    <button
                      className={`${
                        selected
                          ...
                          : ''
                      } hover:border-white-light -mb-[1px] block w-full border border-transparent p-3.5 py-2 hover:border-b-white dark:hover:border-[#191e3a] dark:hover:border-b-black`}
                    >
                      Home
                    </button>
                  </div>
...
export default ComponentsTabsJustify;
