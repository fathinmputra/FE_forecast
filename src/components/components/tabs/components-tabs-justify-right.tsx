...
const ComponentsTabsJustifyRight = () => {
...
<div className="mb-5 flex flex-col sm:flex-row">
    ...
    >
      <div className='mb-5'>
        {isMounted && (
          <Tab.Group>
            <Tab.List className='border-white-light mt-3 flex flex-wrap justify-end border-b dark:border-[#191e3a]'>
              <Tab as={Fragment}>
                {({ selected }) => (
                  <button
                    className={`${
                      selected
                        ...
                        : ''
                                                    ...
                                                    hover:border-white-light -mb-[1px] block border border-transparent p-3.5 py-2 hover:border-b-white dark:hover:border-[#191e3a] dark:hover:border-b-black`}
                  >
                    Home
                  </button>
                )}
...
export default ComponentsTabsJustifyRight;
