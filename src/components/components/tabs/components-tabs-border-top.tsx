        ...
        {isMounted && (
          <Tab.Group>
                    ...
                    className={`${
                      selected
                        ...
                        : ''
                                                    ...
                                                    ' hover:border-secondary hover:text-secondary flex items-center border-t-2 border-transparent bg-[#f6f7f8] p-7 py-3 before:inline-block dark:bg-transparent dark:hover:bg-[#191e3a]`}
                  >
            ...
            <Tab.Panels>
              ...
              <Tab.Panel>
                <div className='border-white-light !border-l-primary mt-5 rounded-br-md rounded-tr-md border border-l-2 bg-white p-5 pt-5 text-black shadow-md ltr:pl-3.5 rtl:pr-3.5 dark:border-[#060818] dark:bg-[#060818]'>
                  <div className='flex items-start'>
