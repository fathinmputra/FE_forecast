...
const ComponentsTabsJustifyRightPills = () => {
                  ...
                  <button
                    className={`${
                      selected ? 'bg-info text-white !outline-none' : ''
                                                    ...
                                                    ' hover:bg-info -mb-[1px] block rounded p-3.5 py-2 hover:text-white`}
                  >
                    Home
                  </button>
                )}
...
export default ComponentsTabsJustifyRightPills;
