...
const ComponentsDashboardCrypto = () => {
  ...
  const profiteChartOption: ApexOptions = {
    chart: {
      height: 45,
      width: 120,
      type: 'line',
  ...
  const lossChartOption: ApexOptions = {
    chart: {
      height: 45,
      width: 120,
      type: 'line',
  ...
  const selectedBitCoinChart: { options: ApexOptions } = {
    options: {
      chart: {
        height: 411,
        type: 'line',
    ...
    <div>
      ...
      <div className='relative mt-5 flex flex-col gap-5 xl:flex-row'>
        <div
          ...
          } panel absolute z-10 hidden w-80 flex-none divide-y divide-[#ebedf2] overflow-y-auto border-0 p-0 xl:relative xl:block dark:divide-[#191e3a]`}
        >
          {coins.map(item => {
            return (
              <div key={item.id}>
                ...
                >
                  <div className='ltr:pr-4 rtl:pl-4'>
                    <div className='flex items-baseline font-semibold'>
                      ...
                      <div className='text-white-dark text-xs uppercase'>
                        ({item.alias})
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div className='flex items-center font-normal'>
                        <IconArrowLeft
                          className={item.isUp ? '-rotate-90' : 'rotate-90'}
                        />
                  ...
                  <div className='flex-1'>
                    {isMounted && (
                      <ReactApexChart
                        series={item.series}
                        options={
                          item.isUp ? profiteChartOption : lossChartOption
                        }
                        type='line'
                        height={45}
                        width='100%'
        ...
        <div
          className={`absolute z-[5] hidden h-full w-full rounded-md bg-black/60 ${
            isShowCryptoMenu ? '!block xl:!hidden' : ''
          }`}
          onClick={() => setIsShowCryptoMenu(!isShowCryptoMenu)}
        ></div>

        <div className='panel flex-1 p-0'>
          <div className='flex-wrap items-center border-b border-[#ebedf2] p-4 md:flex dark:border-[#191e3a]'>
            <div className='flex flex-1 items-start ltr:pr-4 rtl:pl-4'>
              <button
                onClick={() => setIsShowCryptoMenu(!isShowCryptoMenu)}
                type='button'
                className='hover:text-primary block xl:hidden ltr:mr-5 rtl:ml-5'
              >
                <IconMenu />
              </button>
              <div>
                <div className='flex items-center'>
                  ...
                  <div className='text-white-dark text-xs font-semibold uppercase'>
                    ({currentCoin.alias})
                  </div>
                </div>
                <div
                  className={`mt-2 flex items-center ${
                    currentCoin.isUp ? 'text-success' : 'text-danger'
                  }`}
                >
                  <div className='min-w-20 text-2xl ltr:mr-3 rtl:ml-3'>
                    ${currentCoin.value}
                  </div>

                  <IconArrowLeft
                    className={`mb-px ${
                      currentCoin.isUp ? '-rotate-90' : 'rotate-90'
                    }`}
                  />
            ...
            <ul className='text-white-dark mt-5 grid grid-cols-2 divide-[#ebedf2] font-semibold sm:mt-0 sm:grid-cols-4 sm:divide-x ltr:md:ml-auto rtl:divide-x-reverse rtl:md:mr-auto dark:divide-[#253b5c]'>
              <li className='px-4 py-1'>
                Market Cap
                <span className='dark:text-white-light mt-1.5 block text-lg text-black'>
          ...
          <div className='mb-5 grid grid-rows-1 gap-4 border-b border-[#ebedf2] p-4 sm:grid-cols-4 dark:border-[#253b5c]'>
            <div>
            ...
            <div>
              ...
              <div className='relative flex'>
                <input
                  type='text'
                  placeholder=''
                  className='form-input ltr:rounded-r-none ltr:border-r-0 rtl:rounded-l-none rtl:border-l-0'
                />
