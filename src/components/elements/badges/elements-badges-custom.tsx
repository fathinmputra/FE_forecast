      ...
      <div className='mb-5'>
        <div className='flex flex-wrap items-center justify-center gap-3'>
          <button type='button' className='btn btn-primary my-4'>
            ...
            <span className='badge bg-danger absolute -top-3 rounded-full p-0.5 px-1.5 ltr:right-0 rtl:left-0'>
              9
            </span>
          </button>
          <button type='button' className='btn btn-info my-4'>
          ...
          <button type='button' className='btn btn-dark my-4'>
            Notifications
            <span className='badge bg-white-light my-0 text-black ltr:ml-4 rtl:mr-4'>
              4
            </span>
          </button>
          <div className='flex flex-wrap items-center justify-center gap-3'>
            <span className='badge bg-warning my-4 flex items-center rounded-full p-0 text-base ltr:pr-4 rtl:pl-4'>
              <span className='relative h-10 w-10 rounded-full'>
                <Image
            ...
            <span className='badge bg-danger my-4 flex items-center rounded-full p-0 text-base ltr:pr-4 rtl:pl-4'>
              <span className='relative h-10 w-10 rounded-full'>
                <Image
                  src='/assets/images/profile-34.jpeg'
                  alt='John Doe'
              ...
              <span className='ltr:ml-2 rtl:mr-2'>John Doe</span>
              <span className='cursor-pointer hover:opacity-90 ltr:ml-4 rtl:mr-4'>
                x
              </span>
            </span>
          </div>
