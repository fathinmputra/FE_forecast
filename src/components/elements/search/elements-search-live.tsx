    ...
    >
      <div className='mb-5 space-y-5'>
        <div>
          ...
          <div className='border-white-dark/20 block w-full space-y-4 overflow-x-auto rounded-lg border p-4'>
            {filteredItems.map((item: Item) => (
              <div
                key={item.email}
                className='hover:text-primary flex min-w-[625px] items-center justify-between rounded-xl bg-white p-3 font-semibold text-gray-500 shadow-[0_0_4px_2px_rgb(31_45_61_/_10%)] transition-all duration-300 hover:scale-[1.01] dark:bg-[#1b2e4b]'
              >
                <div className='user-profile'>
                  <Image
