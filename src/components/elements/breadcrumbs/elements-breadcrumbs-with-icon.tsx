...
const ElementsBreadcrumbsWithIcon = () => {
  return (
    ...
    >
      <div className='mb-5'>
        <ol className='dark:text-white-dark flex flex-wrap items-center gap-y-4 font-semibold text-gray-500'>
          <li>
            <button className='dark:hover:text-white-dark/70 flex items-center justify-center rounded-md border border-gray-500/20 p-2.5 shadow hover:text-gray-500/70 dark:border-0 dark:bg-[#191e3a]'>
              <IconHome />
            </button>
          </li>
          <li className='before:bg-primary flex items-center before:relative before:-top-0.5 before:mx-4 before:inline-block before:h-1 before:w-1 before:rounded-full'>
            <button className='text-primary flex items-center justify-center rounded-md border border-gray-500/20 p-2.5 shadow dark:border-0 dark:bg-[#191e3a]'>
