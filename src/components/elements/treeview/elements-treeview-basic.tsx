      ...
      <div className='mb-5'>
        <ul className='font-semibold'>
          <li>
            ...
            >
              {treeview2.includes('parent') ? (
                <IconFolderPlus className='text-primary relative -top-1 inline ltr:mr-2 rtl:ml-2' />
              ) : (
                <IconFolderMinus className='text-primary relative -top-1 inline ltr:mr-2 rtl:ml-2' />
              )}
              Parent Node
            </button>
            <AnimateHeight
            ...
            >
              <ul>
                <li className='py-[5px] ltr:pl-7 rtl:pr-7'>
                  <button
                    type='button'
                    className={`${treeview2.includes('img') ? 'open' : ''} `}
                ...
                <li className='py-[5px] ltr:pl-7 rtl:pr-7'>
                  <button
                    type='button'
                    className={`${treeview2.includes('css') ? 'open' : ''} `}
                  ...
                  >
                    <ul>
                      <li className='text-secondary py-[5px] ltr:pl-7 rtl:pr-7'>
                        style.css
                      </li>
                    </ul>
                  </AnimateHeight>
