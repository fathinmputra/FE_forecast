      ...
      <div className='mb-5'>
        <ul className='font-semibold'>
          <li className='py-[5px]'>
            ...
            >
              <IconCaretDown
                className={`text-primary relative -top-1 inline h-5 w-5 ltr:mr-2 rtl:ml-2 ${
                  treeview1.includes('css') && 'rotate-180'
                }`}
              />
              <IconFolder className='text-primary relative -top-1 inline ltr:mr-2 rtl:ml-2' />
              CSS
            </button>
            <AnimateHeight
              duration={300}
            ...
            >
              <ul className='ltr:pl-14 rtl:pr-14'>
                <li className='py-[5px]'>
                  <IconTxtFile className='h-4.5 w-4.5 text-primary inline ltr:mr-2 rtl:ml-2' />
                  style.css
                </li>
              </ul>
            </AnimateHeight>
