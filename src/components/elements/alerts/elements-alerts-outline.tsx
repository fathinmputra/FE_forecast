...
<div className="flex items-center border p-3.5 rounded text-white-dark border-danger">
    ...
    >
      <div className='mb-5 grid gap-5 lg:grid-cols-2'>
        <div className='border-primary text-white-dark flex items-center rounded border p-3.5'>
          <span className='ltr:pr-2 rtl:pl-2'>
            <strong className='ltr:mr-2 rtl:ml-2'>Primary!</strong>Lorem Ipsum
        ...
        <div className='border-danger text-white-dark flex items-center rounded border p-3.5'>
          <span className='ltr:pr-2 rtl:pl-2'>
            <strong className='ltr:mr-2 rtl:ml-2'>Danger!</strong>Lorem Ipsum is
