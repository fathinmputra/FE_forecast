    ...
    >
      <div className='mb-5'>
        <div className='flex items-center justify-center -space-x-4 text-white rtl:space-x-reverse'>
          <Image
            className='dark:ring-white-dark relative h-12 w-12 rounded-full object-cover ring-2 ring-white transition-all duration-300 hover:translate-x-2'
            src='/assets/images/profile-12.jpeg'
            alt='img'
            width={48}
            height={48}
          ...
          <Image
            ...
            height={48}
          />
          <span className='bg-info dark:ring-white-dark relative flex h-12 w-12 items-center justify-center rounded-full object-cover text-center text-base ring-2 ring-white transition-all duration-300 hover:translate-x-2'>
            AG
          </span>
        </div>
      </div>
