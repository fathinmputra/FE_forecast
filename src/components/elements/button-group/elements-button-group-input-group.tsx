        ...
        <div className='flex w-full flex-wrap items-center justify-center gap-2 sm:justify-between'>
          ...
          <div className='relative flex flex-wrap items-stretch'>
            <div className='flex ltr:-mr-px rtl:-ml-px'>
              <span className='border-white-light dark:text-white-dark flex items-center justify-center border bg-[#f1f2f3] px-4 py-1.5 text-black ltr:rounded-l rtl:rounded-r dark:border-[#17263c] dark:bg-[#1a1c2d]'>
                @
              </span>
            </div>
            <input
