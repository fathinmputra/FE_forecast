  ...
  return (
    <div>
      ...
      >
        <button
          type='button'
          className='bg-primary absolute bottom-0 top-0 my-auto flex h-10 w-12 cursor-pointer items-center justify-center text-white ltr:-left-12 ltr:rounded-bl-full ltr:rounded-tl-full rtl:-right-12 rtl:rounded-br-full rtl:rounded-tr-full'
