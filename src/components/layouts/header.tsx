        ...
        <div className='relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black'>
          ...
          <div className='flex items-center space-x-1.5 sm:flex-1 lg:space-x-2 ltr:ml-auto ltr:sm:ml-0 rtl:mr-auto rtl:space-x-reverse sm:rtl:mr-0 dark:text-[#d0d2d6]'>
                ...
                <ul className='text-dark dark:text-white-dark w-[300px] !py-0 text-xs sm:w-[375px]'>
                  ...
                  {messages.length > 0 ? (
                    ...
                    <li className='mb-5' onClick={e => e.stopPropagation()}>
                      ...
                      >
                        <div className='ring-primary/30 mx-auto mb-4 rounded-full text-white ring-4'>
            ...
            <div className='dropdown shrink-0'>
              ...
              >
                <ul className='text-dark dark:text-white-dark w-[300px] divide-y !py-0 sm:w-[350px] dark:divide-white/10'>
                  <li onClick={e => e.stopPropagation()}>
                  ...
                  {notifications.length > 0 ? (
                          ...
                          >
                            <div className='group flex items-center px-4 py-2'>
                              <div className='grid place-content-center rounded'>
                                <div className='relative h-12 w-12'>
                                  <Image
                                    ...
                                    height={48}
                                  />
                                  <span className='bg-success absolute bottom-0 right-[6px] block h-2 w-2 rounded-full'></span>
                                </div>
                              </div>
                              <div className='flex flex-auto ltr:pl-3 rtl:pr-3'>
                                ...
                                <button
                                  type='button'
                                  className='hover:text-danger text-neutral-300 opacity-0 group-hover:opacity-100 ltr:ml-auto rtl:mr-auto'
                                  onClick={() =>
                    ...
                    <li onClick={e => e.stopPropagation()}>
                      <button
                        ...
                        className='!grid min-h-[200px] place-content-center text-lg hover:!bg-transparent'
                      >
                        <div className='ring-primary/30 mx-auto mb-4 rounded-full ring-4'>
                          <IconInfoCircle
                            fill={true}
