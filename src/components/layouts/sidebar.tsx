...
const Sidebar = () => {
  ...
  const sidebarRef = useRef(themeConfig.sidebar);

  useEffect(() => {
    sidebarRef.current = themeConfig.sidebar;
  }, [themeConfig.sidebar]);
        ...
        <div className='h-full bg-white dark:bg-black'>
          ...
          <PerfectScrollbar className='relative h-[calc(100vh-80px)]'>
            <ul className='relative space-y-0.5 p-4 py-0 font-semibold'>
              ...
              <h2 className='bg-white-light/30 dark:bg-dark -mx-4 mb-1 flex items-center px-7 py-3 font-extrabold uppercase dark:bg-opacity-[0.08]'>
              ...
              <li className='menu nav-item'>
                ...
                >
                  ...
                  <div
                    className={
                      currentMenu !== 'page' ? '-rotate-90 rtl:rotate-90' : ''
                    }
                  >
                    <IconCaretDown />
                  </div>
              ...
              <li className='menu nav-item'>
                ...
                >
                  ...
                  <div
                    className={
                      currentMenu !== 'auth' ? '-rotate-90 rtl:rotate-90' : ''
                    }
                  >
                    <IconCaretDown />
                  </div>
