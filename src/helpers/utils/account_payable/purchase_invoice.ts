export interface PurchaseInvoiceProperty {
...
export const purchaseInvoiceInitialState: PurchaseInvoiceProperty = {
...
export interface PurchaseInvoiceUpdateProperty {
  invoice_date?: Date | null;
  due_date?: Date | null;
  received_date?: Date | null;
  description?: string | null;
