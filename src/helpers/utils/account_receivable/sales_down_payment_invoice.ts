export interface SalesDownPaymentInvoiceProperty {
...
export const salesDownPaymentInvoiceInitialState: SalesDownPaymentInvoiceProperty =
  {
...
export interface SalesDownPaymentInvoiceDetail {
  pkid: number;
  code: string;
...
export interface SalesDownPaymentInvoiceUpdateProperty {
  invoice_date?: Date | null;
  due_date?: Date | null;
  dispatched_date?: Date | null;
  description?: string | null;
