...
const KnowledgeBase = () => {
  return (
    <div>
        ...
        <div className='rtl:rotate-y-180 absolute -bottom-1 -end-6 hidden text-[#DBE7FF] lg:block xl:end-0 dark:text-[#1B2E4B]'>
          ...
          >
            <g clipPath='url(#clip0_1109_89938)'>
              ...
              />
              <path
                d='M307.899 24.6635L307.791 25.4761L312.184 26.0541L312.292 25.2415L307.899 24.6635Z'
                fill='#2F2E41'
              />
              <path
                d='M321.765 26.4873L321.657 27.2998L326.05 27.8778L326.158 27.0653L321.765 26.4873Z'
                fill='#2F2E41'
              />
              <path
      ...
      <div className='mt-10 flex flex-col-reverse items-center justify-between gap-5 rounded-md bg-gradient-to-tl from-[rgba(234,241,255,0.44)] to-[rgba(234,241,255,0.96)] px-6 py-2.5 md:flex-row lg:mt-20 xl:px-16 dark:from-[rgba(14,23,38,0.44)] dark:to-[#0E1726]'>
        <div className='flex-1 py-3.5 text-center md:text-start'>
          <h3 className='mb-2 text-xl font-bold md:text-2xl dark:text-white'>
            Did’t find any solutions?
          </h3>
          <div className='text-white-dark text-lg font-medium'>
            Loaded with awesome features like documentation, knowledge base
            forum, domain transfer, affiliates etc.
          </div>
        ...
        <div className='relative h-[200px] w-52 max-w-xs lg:w-full'>
          <Image
            src='/assets/images/knowledge/find-solution.svg'
            alt='find-solution'
            layout='fill'
            objectFit='cover'
            className='rtl:rotate-y-180 dark:brightness-[2.59] dark:grayscale-[83%]'
          />
        </div>
      </div>
      <div className='mt-10'>
        ...
        <div className='grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4'>
          <div className='border-white-light space-y-5 rounded-md border bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black'>
            <div className='relative h-[200px] max-h-56 overflow-hidden rounded-md'>
              <Image
                src='/assets/images/knowledge/image-1.jpg'
                alt='...'
                layout='fill'
                objectFit='cover'
              />
            ...
            <div className='flex'>
              <div className='bg-white-dark relative me-4 h-11 w-11 overflow-hidden rounded-full'>
                <Image
              ...
              <div className='flex-1'>
                <h4 className='mb-1.5 font-semibold dark:text-white'>
                  Alma Clark
                </h4>
                <p>06 May</p>
              </div>
          ...
          <div className='border-white-light space-y-5 rounded-md border bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black'>
            <div className='max-h-56 overflow-hidden rounded-md'>
              <Image
                src='/assets/images/knowledge/image-2.jpg'
                alt='...'
                layout='fill'
                objectFit='cover'
              />
          ...
          <div className='border-white-light space-y-5 rounded-md border bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black'>
            <div className='max-h-56 overflow-hidden rounded-md'>
              <Image
                src='/assets/images/knowledge/image-3.jpg'
                alt='...'
                layout='fill'
                objectFit='cover'
              />
          ...
          <div className='border-white-light space-y-5 rounded-md border bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black'>
            <div className='max-h-56 overflow-hidden rounded-md'>
              <Image
                src='/assets/images/knowledge/image-4.jpg'
                alt='...'
                layout='fill'
                objectFit='cover'
              />
            ...
            <div className='flex'>
              <div className='bg-white-dark me-4 overflow-hidden rounded-full'>
                <Image
