  ...
  return (
    <div>
      <div className='space-y-8'>
        <div className='panel text-primary flex items-center overflow-x-auto whitespace-nowrap p-3 lg:col-span-2'>
          <div className='bg-primary ring-primary/30 rounded-full p-1.5 text-white ring-2 ltr:mr-3 rtl:ml-3'>
            <IconBell />
          </div>
        ...
        <div className='panel'>
          ...
          <div className='mb-5'>
            <p className='mb-5'>
              Solar is a collection of simply beautiful open source icons. Each
            ...
            <div className='mb-5 flex flex-wrap items-center gap-10'>
              <div className='border-white-dark/20 grid h-14 w-14 place-content-center rounded-md border dark:border-[#191e3a]'>
              ...
              <div className='border-white-dark/20 grid h-14 w-14 place-content-center rounded-md border dark:border-[#191e3a]'>
                <IconMoneyReceive className='h-6 w-6' />
              </div>
              <div className='border-white-dark/20 grid h-14 w-14 place-content-center rounded-md border dark:border-[#191e3a]'>
                <IconMoneySend className='h-6 w-6' />
              </div>
              <div className='border-white-dark/20 grid h-14 w-14 place-content-center rounded-md border dark:border-[#191e3a]'>
